  ...
  return (
    <form onSubmit={submit} className="flex flex-col gap-4">
      ...
      <button type="submit" disabled={loading}
        className="w-full py-4 text-sm font-bold tracking-widest uppercase transition-all duration-300 rounded-none flex items-center justify-center gap-2 bg-[#0B3A3D] text-white border-2 border-[#0B3A3D] hover:bg-[#CD9E4B] hover:border-[#CD9E4B]"
        style={{ marginTop: '4px' }}>
    ...
    <div className="container mx-auto px-4 md:px-8 relative z-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-stretch max-w-6xl mx-auto">
        ...
        <div 
          ...
          data-aos-delay="100"
        >
          <h2 className="text-[18px] sm:text-[24px] md:text-[28px] font-semibold leading-tight uppercase tracking-wider text-white mb-3" style={{ fontFamily: "var(--font-jost), Montserrat, sans-serif" }}>
            Get In Touch
          </h2>
          {/* Decorative Line */}
