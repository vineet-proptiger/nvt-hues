      ...
      <div className="container mx-auto px-4 md:px-8 max-w-[1200px]">
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-stretch">
          ...
          <div className="w-full lg:w-[46%] lg:order-2" data-aos="fade-left" data-aos-duration="1000">
            <div 
              className="p-3.5 sm:p-5 lg:px-6 lg:py-[18px] rounded-2xl bg-white border border-[#CD9E4B] shadow-[0_12px_32px_rgba(0,2,66,0.12)] flex flex-col h-full justify-between"
            >
              <div>
                {/* Header Title & Origin Badge */}
                <div className="flex flex-wrap items-center justify-between gap-y-2 gap-x-3 pb-2.5 mb-3.5 border-b-2 border-[#CD9E4B]">
                  <h3 
                  ...
                  >
                    <MapPin size={20} className="text-[#0B3A3D] shrink-0" />
                ...
                <div className="relative pl-6 flex flex-col justify-between py-1">
                  ...
                  <div 
                    ...
                    style={{
                      background: 'linear-gradient(to bottom, #CD9E4B 0%, #0B3A3D 50%, #CD9E4B 100%)'
                    }}
                  />
                  ...
                  {locationLandmarks.map((item, index) => (
                    ...
                    >
                      ...
                      <div className="absolute -left-6 w-[24px] flex items-center justify-center pointer-events-none">
                        <span className="w-[10px] h-[10px] rounded-full bg-white border-[2.5px] border-[#CD9E4B] group-hover:scale-125 group-hover:border-[#0B3A3D] transition-transform duration-200 shadow-xs" />
                      </div>

                      {/* Landmark Name */}
                      <span 
                        className="text-[14.5px] font-semibold text-gray-800 group-hover:text-[#0B3A3D] transition-colors pl-1"
                      ...
                      {/* Distance Time Badge */}
                      <span 
                        className="text-[12px] font-extrabold text-[#2e4213] bg-[#F4EFE3] border border-[#c4e49f] px-2.5 py-0.5 rounded-full whitespace-nowrap shadow-2xs ml-3"
                        style={{ fontFamily: F_JOST }}
                      >
                        {item.dist}
                      </span>
              ...
              {/* <div className="mt-3 pt-2.5 border-t border-[#edf4e3] flex items-center justify-between text-[11px] text-gray-500 font-medium">
                <span className="flex items-center gap-1.5">
                  <span className="w-2 h-2 rounded-full bg-[#CD9E4B] animate-pulse"></span> Prime Whitefield-Varthur Sarjapur East Bangalore Corridor
                </span>
                <span className="text-[#0B3A3D] font-bold">Bangalore East</span>
              </div> */}
            </div>
          </div>
          ...
          <div className="w-full lg:flex-1 lg:order-1 flex flex-col justify-center" data-aos="fade-right" data-aos-duration="1000">
            <div style={{
              ...
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3889.0153902900283!2d77.7530483!3d12.9067318!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae0d3da5cdc16d%3A0xca9a915c15cb0497!2sA%20Life%20in%20Bloom%20by%20NVT!5e0!3m2!1sen!2sin!4v1789980301127!5m2!1sen!2sin" 
              ...
              <div style={{
                ...
                background: 'var(--color-gold, #CD9E4B)', opacity: 0.95, backdropFilter: 'blur(6px)',
                ...
                <span style={{
                  ...
                  Whitefield-Varthur Sarjapur East Bangalore
                </span>
              </div>
            </div>
          </div>
