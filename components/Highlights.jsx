...
import { Trees, Layers, Maximize2, Sun, Flower2 } from 'lucide-react'

const highlightsData = [
  {
    title: '10-Acre Villa Community',
    desc: 'An expansive 10-acre villa community featuring 107 luxury villas.',
    bg: 'bg-[#eefcee]',
    color: 'text-[#CD9E4B]',
    delay: '0s',
    floatDelay: '0s',
    icon: <Trees className="w-9 h-9 text-[#CD9E4B]" strokeWidth={2} />
  },
  {
    title: 'Phase 1: 7 Acres & 62 Villas',
    desc: 'Phase 1 spans 7 acres and features 62 exclusive luxury villas.',
    bg: 'bg-[#fdf8ee]',
    color: 'text-[#d97706]',
    delay: '0.1s',
    floatDelay: '0.2s',
  ...
  {
    title: '3,750 – 4,432 Sq. Ft.',
    desc: 'Spacious villas with built-up areas ranging from 3,750 to 4,432 sq. ft.',
    bg: 'bg-[#f5eefc]',
    color: 'text-[#9333ea]',
    delay: '0.2s',
    floatDelay: '0.4s',
    icon: <Maximize2 className="w-9 h-9 text-[#9333ea]" strokeWidth={2} />
  },
  {
    title: 'Skydeck & Private Backyard',
    desc: 'Private backyard, exclusive skydeck and expansive skylight with every villa.',
    bg: 'bg-[#f0fdfa]',
    color: 'text-[#0d9488]',
    delay: '0.3s',
    floatDelay: '0.6s',
