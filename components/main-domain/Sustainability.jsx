    ...
    <section id="sustainability" style={{
      ...
      <div className="container mx-auto px-4 md:px-8 max-w-[1100px] relative z-10">
        ...
        <div style={{ marginBottom: '40px', textAlign: 'center' }} data-aos="fade-up">
          <h2
            className="text-[18px] sm:text-[24px] md:text-[28px] font-semibold leading-tight uppercase tracking-wider text-gray-900 text-center"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-[1px] bg-[#dcdfe4]">
            {sustainabilityItems.map((item, idx) => (
              <div key={idx} className="flex flex-col items-center group" style={{
                ...
                {/* Icon */}
                <div className="w-[80px] h-[80px] rounded-full flex items-center justify-center mb-6 text-white group-hover:scale-105 transition-transform duration-300" style={{ background: '#CD9E4B' }}>
