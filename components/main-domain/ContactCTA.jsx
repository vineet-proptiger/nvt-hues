      ...
      <div className="container mx-auto px-4 relative z-10 max-w-6xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white" data-aos="fade-right" data-aos-duration="1000">
            <h2 className="text-[18px] sm:text-[24px] md:text-[28px] font-semibold leading-tight uppercase tracking-wider text-white mb-6" style={{ fontFamily: "var(--font-jost), Montserrat, sans-serif" }}>
              Get In Touch
            </h2>
            ...
            {success ? (
              ...
              <form onSubmit={submit} className="flex flex-col gap-6">
                ...
                <button type="submit" disabled={loading}
                  className="w-full py-4 mt-2 text-sm font-bold tracking-widest uppercase transition-all duration-300 rounded-lg bg-[#0B3A3D] text-white hover:bg-[#CD9E4B] cursor-pointer"
                  style={{ fontFamily: F_SANS }}>
