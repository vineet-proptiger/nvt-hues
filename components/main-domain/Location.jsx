        ...
        <div className="flex flex-col lg:flex-row gap-8 items-stretch">
            ...
            >
              ...
              {/* <div className="mt-3 pt-2.5 border-t border-[#edf4e3] flex items-center justify-between text-[11px] text-gray-500 font-medium">
                <span className="flex items-center gap-1.5">
                  <span className="w-2 h-2 rounded-full bg-[#CD9E4B] animate-pulse"></span> Prime Gunjur, Bangalore Corridor
                </span>
          ...
          <div className="w-full lg:flex-1 lg:order-1 flex flex-col justify-center" data-aos="fade-right" data-aos-duration="1000">
            <div style={{
              ...
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3889.0952887097274!2d77.74830657507525!3d12.90159398740734!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae0d00739134ab%3A0x9644cff9e0cc28ba!2sNVT%20Whispering%20Hues!5e0!3m2!1sen!2sin!4v1790068280007!5m2!1sen!2sin" 
